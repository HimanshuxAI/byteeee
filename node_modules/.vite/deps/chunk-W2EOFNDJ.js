...
// node_modules/mermaid/dist/chunks/mermaid.esm.min/chunk-GOL2OBWC.mjs
var nt = Object.freeze({ left: 0, top: 0, width: 16, height: 16 });
var A = Object.freeze({ rotate: 0, vFlip: false, hFlip: false });
var K = Object.freeze({ ...nt, ...A });
var Te = Object.freeze({ ...K, body: "", hidden: false });
var rt = Object.freeze({ width: null, height: null });
var Ie = Object.freeze({ ...rt, ...A });
var X = m((n, e, r, s = "") => {
  let t = n.split(":");
  if (n.slice(0, 1) === "@") {
  ...
  if (t.length > 1) {
    let o = t.pop(), a = t.pop(), c = { provider: t.length > 0 ? t[0] : s, prefix: a, name: o };
    return e && !O(c) ? null : c;
  }
  let l = t[0], i = l.split("-");
  if (i.length > 1) {
    let o = { provider: s, prefix: i.shift(), name: i.join("-") };
    return e && !O(o) ? null : o;
  }
  if (r && s === "") {
    let o = { provider: s, prefix: "", name: l };
    return e && !O(o, r) ? null : o;
  }
  return null;
}, "stringToIcon");
var O = m((n, e) => n ? !!((e && n.prefix === "" || n.prefix) && n.name) : false, "validateIconName");
function $e(n, e) {
  let r = {};
  !n.hFlip != !e.hFlip && (r.hFlip = true), !n.vFlip != !e.vFlip && (r.vFlip = true);
...
m(J, "mergeIconData");
function Re(n, e) {
  let r = n.icons, s = n.aliases || /* @__PURE__ */ Object.create(null), t = /* @__PURE__ */ Object.create(null);
  function l(i) {
    if (r[i]) return t[i] = [];
    if (!(i in t)) {
      t[i] = null;
  ...
  return m(l, "resolve"), (e || Object.keys(r).concat(Object.keys(s))).forEach(l), t;
}
m(Re, "getIconsTree");
function ze(n, e, r) {
  let s = n.icons, t = n.aliases || /* @__PURE__ */ Object.create(null), l = {};
  function i(o) {
    l = J(s[o] || t[o], l);
  }
...
m(Y, "getIconData");
var st = /(-?[0-9.]*[0-9]+[0-9.]*)/g;
var it = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function ee(n, e, r) {
  if (e === 1) return n;
  ...
  let t = [], l = s.shift(), i = it.test(l);
  for (; ; ) {
    if (i) {
      let o = parseFloat(l);
      isNaN(o) ? t.push(l) : t.push(Math.ceil(o * e * r) / r);
    } else t.push(l);
    if (l = s.shift(), l === void 0) return t.join("");
    i = !i;
  }
}
m(ee, "calculateSize");
function ot2(n, e = "defs") {
  let r = "", s = n.indexOf("<" + e);
  for (; s >= 0; ) {
    let t = n.indexOf(">", s), l = n.indexOf("</" + e);
    if (t === -1 || l === -1) break;
    let i = n.indexOf(">", l);
    if (i === -1) break;
    r += n.slice(t + 1, l).trim(), n = n.slice(0, s).trim() + n.slice(i + 1);
  }
  return { defs: r, content: n };
}
m(ot2, "splitSVGDefs");
function lt(n, e) {
...
m(Ee, "wrapSVGContent");
var at = m((n) => n === "unset" || n === "undefined" || n === "none", "isUnsetKeyword");
function te(n, e) {
  let r = { ...K, ...n }, s = { ...Ie, ...e }, t = { left: r.left, top: r.top, width: r.width, height: r.height }, l = r.body;
  [r, s].forEach((x) => {
    ...
    S % 2 === 1 && (t.left !== t.top && (y = t.left, t.left = t.top, t.top = y), t.width !== t.height && (y = t.width, t.width = t.height, t.height = y)), b.length && (l = Ee(l, '<g transform="' + b.join(" ") + '">', "</g>"));
  });
  let i = s.width, o = s.height, a = t.width, c = t.height, h, f;
  i === null ? (f = o === null ? "1em" : o === "auto" ? c : o, h = ee(f, a / c)) : (h = i === "auto" ? a : i, f = o === null ? ee(h, c / a) : o === "auto" ? c : o);
  let u = {}, m2 = m((x, b) => {
    at(b) || (u[x] = b.toString());
  }, "setAttr");
  m2("width", h), m2("height", f);
  let k = [t.left, t.top, a, c];
  return u.viewBox = k.join(" "), { attributes: u, viewBox: k, body: l };
}
m(te, "iconToSVG");
var ct = /\sid="(\S+)"/g;
var pt2 = "IconifyId" + Date.now().toString(16) + (Math.random() * 16777216 | 0).toString(16);
var ht = 0;
function ne(n, e = pt2) {
  let r = [], s;
  for (; s = ct.exec(n); ) r.push(s[1]);
  if (!r.length) return n;
  let t = "suffix" + (Math.random() * 16777216 | Date.now()).toString(16);
  return r.forEach((l) => {
    let i = typeof e == "function" ? e(l) : e + (ht++).toString(), o = l.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    n = n.replace(new RegExp('([#;"])(' + o + ')([")]|\\.[a-z])', "g"), "$1" + i + t + "$3");
  }), n = n.replace(new RegExp(t, "g"), ""), n;
}
m(ne, "replaceIDs");
function re(n, e) {
...
m(re, "iconToHTML");
var ut = { body: '<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/><text transform="translate(21.16 64.67)" style="fill: #fff; font-family: ArialMT, Arial; font-size: 67.75px;"><tspan x="0" y="0">?</tspan></text></g>', height: 80, width: 80 };
...
var Hn = m((n) => {
  for (let e of n) {
    ...
    else throw pt.error("Invalid icon loader:", e), new Error('Invalid icon loader. Must have either "icons" or "loader" property.');
  }
}, "registerIconPacks");
var Le = m(async (n, e) => {
  let r = X(n, true, e !== void 0);
  ...
  if (!t) {
    ...
    try {
      t = { ...await i(), prefix: s }, se.set(s, t);
    } catch (o) {
      throw pt.error(o), new Error(`Failed to load icon set: ${r.prefix}`);
    }
  }
  let l = Y(t, r.name);
...
var Me = m(async (n) => {
  try {
    return await Le(n), true;
  } catch {
    return false;
  }
}, "isIconAvailable");
var ve = m(async (n, e, r) => {
  let s;
  try {
  ...
  let t = te(s, e), l = re(ne(t.body), { ...t.attributes, ...r });
  return ot(l, Ot());
}, "getIconSVG");
function Ce(n) {
  ...
  var t = s.reduce(function(o, a) {
    var c = a.match(/\n([\t ]+|(?!\s).)/g);
    return c ? o.concat(c.map(function(h) {
      var f, u;
      return (u = (f = h.match(/[\t ]/g)) === null || f === void 0 ? void 0 : f.length) !== null && u !== void 0 ? u : 0;
    })) : o;
  }, []);
  if (t.length) {
    var l = new RegExp(`
...
m(Fe, "G");
var _ = { exec: m(() => null, "exec") };
function d(n, e = "") {
  let r = typeof n == "string" ? n : n.source, s = { replace: m((t, l) => {
    let i = typeof l == "string" ? l : l.source;
    return i = i.replace(w.caret, "$1"), r = r.replace(t, i), s;
  }, "replace"), getRegex: m(() => new RegExp(r, e), "getRegex") };
  return s;
}
m(d, "h");
var w = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: m((n) => new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`), "listItemRegex"), nextBulletRegex: m((n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), "nextBulletRegex"), hrRegex: m((n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), "hrRegex"), fencesBeginRegex: m((n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}(?:\`\`\`|~~~)`), "fencesBeginRegex"), headingBeginRegex: m((n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}#`), "headingBeginRegex"), htmlBeginRegex: m((n) => new RegExp(`^ {0,${Math.min(3, n - 1)}}<(?:[a-z].*>|!--)`, "i"), "htmlBeginRegex") };
var ft = /^(?:[ \t]*(?:\n|$))+/;
var gt = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/;
var dt = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/;
var B = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/;
var mt = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/;
var ce = /(?:[*+-]|\d{1,9}[.)])/;
var qe = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/;
var Oe = d(qe).replace(/bull/g, ce).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex();
var kt = d(qe).replace(/bull/g, ce).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex();
var pe = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/;
var xt = /^[^\n]+/;
var he = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/;
var bt = d(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", he).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex();
var wt = d(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, ce).getRegex();
...
var ue = /<!--(?:-?>|[\s\S]*?(?:-->|$))/;
var yt = d("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", ue).replace("tag", N).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex();
var We = d(pe).replace("hr", B).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", N).getRegex();
var St = d(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", We).getRegex();
var fe = { blockquote: St, code: gt, def: bt, fences: dt, heading: mt, hr: B, html: yt, lheading: Oe, list: wt, newline: ft, paragraph: We, table: _, text: xt };
var Pe = d("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", B).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", N).getRegex();
var Tt = { ...fe, lheading: kt, table: Pe, paragraph: d(pe).replace("hr", B).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", Pe).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", N).getRegex() };
var It = { ...fe, html: d(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", ue).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: _, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: d(pe).replace("hr", B).replace("heading", ` *#{1,6} *[^
...
var ge = /[\s\p{P}\p{S}]/u;
var Ze = /[^\s\p{P}\p{S}]/u;
var Et = d(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, ge).getRegex();
var He = /(?!~)[\p{P}\p{S}]/u;
var At = /(?!~)[\s\p{P}\p{S}]/u;
var Lt = /(?:[^\s\p{P}\p{S}]|~)/u;
var Mt = /\[[^\[\]]*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g;
var Ne = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/;
var vt = d(Ne, "u").replace(/punct/g, V).getRegex();
var Ct = d(Ne, "u").replace(/punct/g, He).getRegex();
var Ve = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)";
var Pt = d(Ve, "gu").replace(/notPunctSpace/g, Ze).replace(/punctSpace/g, ge).replace(/punct/g, V).getRegex();
var jt = d(Ve, "gu").replace(/notPunctSpace/g, Lt).replace(/punctSpace/g, At).replace(/punct/g, He).getRegex();
var Dt = d("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, Ze).replace(/punctSpace/g, ge).replace(/punct/g, V).getRegex();
var _t = d(/\\(punct)/, "gu").replace(/punct/g, V).getRegex();
var Bt = d(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex();
var Ft = d(ue).replace("(?:-->|$)", "-->").getRegex();
var qt = d("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", Ft).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex();
var G = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`[^`]*`|[^\[\]\\`])*?/;
var Ot2 = d(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", G).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex();
var Ue = d(/^!?\[(label)\]\[(ref)\]/).replace("label", G).replace("ref", he).getRegex();
var Qe = d(/^!?\[(ref)\](?:\[\])?/).replace("ref", he).getRegex();
var Wt = d("reflink|nolink(?!\\()", "g").replace("reflink", Ue).replace("nolink", Qe).getRegex();
var de = { _backpedal: _, anyPunctuation: _t, autolink: Bt, blockSkip: Mt, br: Ge, code: Rt, del: _, emStrongLDelim: vt, emStrongRDelimAst: Pt, emStrongRDelimUnd: Dt, escape: $t, link: Ot2, nolink: Qe, punctuation: Et, reflink: Ue, reflinkSearch: Wt, tag: qt, text: zt, url: _ };
var Gt = { ...de, link: d(/^!?\[(label)\]\((.*?)\)/).replace("label", G).getRegex(), reflink: d(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", G).getRegex() };
var ie = { ...de, emStrongRDelimAst: jt, emStrongLDelim: Ct, url: d(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, "i").replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: /^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/ };
var Zt = { ...ie, br: d(Ge).replace("{2,}", "*").getRegex(), text: d(ie.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() };
var W = { normal: fe, gfm: Tt, pedantic: It };
var P = { normal: de, gfm: ie, breaks: Zt, pedantic: Gt };
var Ht = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
var je = m((n) => Ht[n], "ke");
function T(n, e) {
  if (e) {
...
function Be(n, e, r, s, t) {
  let l = e.href, i = e.title || null, o = n[1].replace(t.other.outputLinkReplace, "$1");
  s.state.inLink = true;
  let a = { type: n[0].charAt(0) === "!" ? "image" : "link", raw: r, href: l, title: i, text: o, tokens: s.inlineTokens(o) };
  return s.state.inLink = false, a;
}
m(Be, "fe");
function Vt(n, e, r) {
...
var Z = class {
  ...
  code(n) {
    ...
    if (e) {
      ...
      return { type: "code", raw: e[0], codeBlockStyle: "indented", text: this.options.pedantic ? r : j(r, `
`) };
    }
  }
  fences(n) {
    ...
    if (e) {
      let r = e[0], s = Vt(r, e[3] || "", this.rules);
...
`), s = "", t = "", l = [];
      for (; r.length > 0; ) {
        let i = false, o = [], a;
        for (a = 0; a < r.length; a++) if (this.rules.other.blockquoteStart.test(r[a])) o.push(r[a]), i = true;
...
${h}` : h;
        ...
        if (this.lexer.state.top = true, this.lexer.blockTokens(h, l, true), this.lexer.state.top = f, r.length === 0) break;
        let u = l.at(-1);
...
` + r.join(`
`), x = this.blockquote(k);
          l[l.length - 1] = x, s = s.substring(0, s.length - m2.raw.length) + x.raw, t = t.substring(0, t.length - m2.text.length) + x.text;
          break;
        } else if (u?.type === "list") {
          let m2 = u, k = m2.raw + `
` + r.join(`
`), x = this.list(k);
          l[l.length - 1] = x, s = s.substring(0, s.length - u.raw.length) + x.raw, t = t.substring(0, t.length - m2.raw.length) + x.raw, r = k.substring(l.at(-1).raw.length).split(`
`);
          continue;
        }
      }
  ...
  list(n) {
    ...
    if (e) {
      let r = e[1].trim(), s = r.length > 1, t = { type: "list", raw: "", ordered: s, start: s ? +r.slice(0, -1) : "", loose: false, items: [] };
      r = s ? `\\d{1,9}\\${r.slice(-1)}` : `\\${r}`, this.options.pedantic && (r = s ? r : "[*+-]");
      let l = this.rules.other.listItemRegex(r), i = false;
      for (; n; ) {
        let a = false, c = "", h = "";
...
`, 1)[0], m2 = !f.trim(), k = 0;
        if (this.options.pedantic ? (k = 2, h = f.trimStart()) : m2 ? k = e[1].length + 1 : (k = e[2].search(this.rules.other.nonSpaceChar), k = k > 4 ? 1 : k, h = f.slice(k), k += e[1].length), m2 && this.rules.other.blankLine.test(u) && (c += u + `
`, n = n.substring(u.length + 1), a = true), !a) {
          let L = this.rules.other.nextBulletRegex(k), M = this.rules.other.hrRegex(k), S = this.rules.other.fencesBeginRegex(k), y = this.rules.other.headingBeginRegex(k), tt = this.rules.other.htmlBeginRegex(k);
          for (; n; ) {
            let U = n.split(`
`, 1)[0], v;
            if (u = U, this.options.pedantic ? (u = u.replace(this.rules.other.listReplaceNesting, "  "), v = u) : v = u.replace(this.rules.other.tabCharGlobal, "    "), S.test(u) || y.test(u) || tt.test(u) || L.test(u) || M.test(u)) break;
            if (v.search(this.rules.other.nonSpaceChar) >= k || !u.trim()) h += `
` + v.slice(k);
            else {
              if (m2 || f.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 || S.test(f) || y.test(f) || M.test(f)) break;
              h += `
` + u;
            }
            !m2 && !u.trim() && (m2 = true), c += U + `
`, n = n.substring(U.length + 1), f = v.slice(k);
          }
        }
        t.loose || (i ? t.loose = true : this.rules.other.doubleBlankLine.test(c) && (i = true));
        let x = null, b;
        this.options.gfm && (x = this.rules.other.listIsTask.exec(h), x && (b = x[0] !== "[ ] ", h = h.replace(this.rules.other.listReplaceTask, ""))), t.items.push({ type: "list_item", raw: c, task: !!x, checked: b, loose: false, text: h, tokens: [] }), t.raw += c;
      }
      let o = t.items.at(-1);
      if (o) o.raw = o.raw.trimEnd(), o.text = o.text.trimEnd();
      else return;
      t.raw = t.raw.trimEnd();
      for (let a = 0; a < t.items.length; a++) if (this.lexer.state.top = false, t.items[a].tokens = this.lexer.blockTokens(t.items[a].text, []), !t.loose) {
        let c = t.items[a].tokens.filter((f) => f.type === "space"), h = c.length > 0 && c.some((f) => this.rules.other.anyLine.test(f.raw));
        t.loose = h;
      }
      if (t.loose) for (let a = 0; a < t.items.length; a++) t.items[a].loose = true;
      return t;
    }
  }
  html(n) {
  ...
  table(n) {
    ...
    let r = _e(e[1]), s = e[2].replace(this.rules.other.tableAlignChars, "").split("|"), t = e[3]?.trim() ? e[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], l = { type: "table", raw: e[0], header: [], align: [], rows: [] };
    if (r.length === s.length) {
      ...
      for (let i = 0; i < r.length; i++) l.header.push({ text: r[i], tokens: this.lexer.inline(r[i]), header: true, align: l.align[i] });
      for (let i of t) l.rows.push(_e(i, l.header.length).map((o, a) => ({ text: o, tokens: this.lexer.inline(o), header: false, align: l.align[a] })));
      return l;
    }
  }
  lheading(n) {
...
` ? e[1].slice(0, -1) : e[1];
  ...
  link(n) {
    ...
    if (e) {
      ...
      return s = s.trim(), this.rules.other.startAngleBracket.test(s) && (this.options.pedantic && !this.rules.other.endAngleBracket.test(r) ? s = s.slice(1) : s = s.slice(1, -1)), Be(e, { href: s && s.replace(this.rules.inline.anyPunctuation, "$1"), title: t && t.replace(this.rules.inline.anyPunctuation, "$1") }, e[0], this.lexer, this.rules);
    }
  }
  reflink(n, e) {
    let r;
  ...
  emStrong(n, e, r = "") {
    ...
    if (!(!s || s[3] && r.match(this.rules.other.unicodeAlphaNumeric)) && (!(s[1] || s[2]) || !r || this.rules.inline.punctuation.exec(r))) {
      ...
      for (c.lastIndex = 0, e = e.slice(-1 * n.length + t); (s = c.exec(e)) != null; ) {
        ...
        if (o -= i, o > 0) continue;
        i = Math.min(i, i + o + a);
        let h = [...s[0]][0].length, f = n.slice(0, t + s.index + h + i);
        if (Math.min(t, i) % 2) {
          let m2 = f.slice(1, -1);
...
var $ = class oe {
  ...
  inlineQueue;
  constructor(e) {
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || E, this.options.tokenizer = this.options.tokenizer || new Z(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: false, inRawBlock: false, top: true };
    let r = { other: w, block: W.normal, inline: P.normal };
...
`), this.blockTokens(e, this.tokens);
  ...
  blockTokens(e, r = [], s = false) {
    for (this.options.pedantic && (e = e.replace(w.tabCharGlobal, "    ").replace(w.spaceLine, "")); e; ) {
      let t;
      if (this.options.extensions?.block?.some((i) => (t = i.call({ lexer: this }, e, r)) ? (e = e.substring(t.raw.length), r.push(t), true) : false)) continue;
...
`) ? "" : `
`) + t.raw, i.text += `
` + t.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = i.text) : r.push(t), s = l.length !== e.length, e = e.substring(t.raw.length);
        continue;
      }
...
` + t.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = i.text) : r.push(t);
  ...
  inlineTokens(e, r = []) {
    ...
    for (; e; ) {
      l || (i = ""), l = false;
      let o;
      if (this.options.extensions?.inline?.some((c) => (o = c.call({ lexer: this }, e, r)) ? (e = e.substring(o.raw.length), r.push(o), true) : false)) continue;
      ...
      if (o = this.tokenizer.emStrong(e, s, i)) {
        e = e.substring(o.raw.length), r.push(o);
        continue;
      }
      ...
      if (this.options.extensions?.startInline) {
        ...
        this.options.extensions.startInline.forEach((u) => {
          f = u.call({ lexer: this }, h), typeof f == "number" && f >= 0 && (c = Math.min(c, f));
        }), c < 1 / 0 && c >= 0 && (a = e.substring(0, c + 1));
      }
      if (o = this.tokenizer.inlineText(a)) {
        e = e.substring(o.raw.length), o.raw.slice(-1) !== "_" && (i = o.raw.slice(-1)), l = true;
        let c = r.at(-1);
...
`;
    return s ? '<pre><code class="language-' + T(s) + '">' + (r ? t : T(t, true)) + `</code></pre>
` : "<pre><code>" + (r ? t : T(t, true)) + `</code></pre>
`;
  }
  blockquote({ tokens: n }) {
    return `<blockquote>
...
`;
  ...
  listitem(n) {
    ...
    if (n.task) {
      ...
      n.loose ? n.tokens[0]?.type === "paragraph" ? (n.tokens[0].text = r + " " + n.tokens[0].text, n.tokens[0].tokens && n.tokens[0].tokens.length > 0 && n.tokens[0].tokens[0].type === "text" && (n.tokens[0].tokens[0].text = r + " " + T(n.tokens[0].tokens[0].text), n.tokens[0].tokens[0].escaped = true)) : n.tokens.unshift({ type: "text", raw: r + " ", text: r + " ", escaped: true }) : e += r + " ";
    }
...
`;
  ...
  link({ href: n, title: e, tokens: r }) {
    let s = this.parser.parseInline(r), t = De(n);
    if (t === null) return s;
    n = t;
    let l = '<a href="' + n + '"';
...
` + this.renderer.text(o);
          r ? s += this.renderer.paragraph({ type: "paragraph", raw: a, text: a, tokens: [{ type: "text", raw: a, text: a, escaped: true }] }) : s += a;
          continue;
        }
        default: {
  ...
  parseInline(e, r = this.renderer) {
    ...
    for (let t = 0; t < e.length; t++) {
      ...
      if (this.options.extensions?.renderers?.[l.type]) {
        ...
        if (o !== false || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(l.type)) {
          s += o || "";
          continue;
        }
      }
...
var Ut = class {
  ...
  use(...n) {
    ...
    return n.forEach((r) => {
      let s = { ...r };
      if (s.async = this.defaults.async || s.async || false, r.extensions && (r.extensions.forEach((t) => {
        if (!t.name) throw new Error("extension name required");
        if ("renderer" in t) {
          let l = e.renderers[t.name];
          l ? e.renderers[t.name] = function(...i) {
            let o = t.renderer.apply(this, i);
            return o === false && (o = l.apply(this, i)), o;
        ...
        for (let l in r.renderer) {
          ...
          t[i] = (...c) => {
            let h = o.apply(t, c);
            return h === false && (h = a.apply(t, c)), h || "";
          };
        }
        s.renderer = t;
      }
      ...
      if (r.hooks) {
        ...
        for (let l in r.hooks) {
          ...
          D.passThroughHooks.has(l) ? t[i] = (c) => {
            if (this.defaults.async && D.passThroughHooksRespectAsync.has(l)) return Promise.resolve(o.call(t, c)).then((f) => a.call(t, f));
            let h = o.call(t, c);
            return a.call(t, h);
          } : t[i] = (...c) => {
            let h = o.apply(t, c);
  ...
  parseMarkdown(n) {
    return (e, r) => {
      let s = { ...r }, t = { ...this.defaults, ...s }, l = this.onError(!!t.silent, !!t.async);
      ...
      if (t.async) return Promise.resolve(t.hooks ? t.hooks.preprocess(e) : e).then((a) => i(a, t)).then((a) => t.hooks ? t.hooks.processAllTokens(a) : a).then((a) => t.walkTokens ? Promise.all(this.walkTokens(a, t.walkTokens)).then(() => a) : a).then((a) => o(a, t)).then((a) => t.hooks ? t.hooks.postprocess(a) : a).catch(l);
      try {
        t.hooks && (e = t.hooks.preprocess(e));
        let a = i(e, t);
        t.hooks && (a = t.hooks.processAllTokens(a)), t.walkTokens && this.walkTokens(a, t.walkTokens);
        let c = o(a, t);
...
Please report this to https://github.com/markedjs/marked.`, n) {
        let s = "<p>An error occurred:</p><pre>" + T(r.message + "", true) + "</pre>";
...
var Jn = g.use;
var Yn = g.walkTokens;
var er = g.parseInline;
var tr = R.parse;
var nr2 = $.lex;
function Qt(n, { markdownAutoWrap: e }) {
  let s = n.replace(/<br\/>/g, `
`).replace(/\n{2,}/g, `
`), t = Ce(s);
  return e === false ? t.replace(/ /g, "&nbsp;") : t;
}
m(Qt, "preprocessMarkdown");
function Ke(n, e = {}) {
  let r = Qt(n, e), s = g.lexer(r), t = [[]], l = 0;
  function i(o, a = "normal") {
    o.type === "text" ? o.text.split(`
`).forEach((h, f) => {
      f !== 0 && (l++, t.push([])), h.split(" ").forEach((u) => {
        u = u.replace(/&#39;/g, "'"), u && t[l].push({ content: u, type: a });
      });
    }) : o.type === "strong" || o.type === "em" ? o.tokens.forEach((c) => {
      i(c, o.type);
    }) : o.type === "html" && t[l].push({ content: o.text, type: "normal" });
  }
  return m(i, "processNode"), s.forEach((o) => {
    o.type === "paragraph" ? o.tokens?.forEach((a) => {
      i(a);
    }) : o.type === "html" ? t[l].push({ content: o.text, type: "normal" }) : t[l].push({ content: o.raw, type: "normal" });
  }), t;
}
...
function ke(n, e, r = [], s = []) {
  ...
  let l = n.shift() ?? { content: " ", type: "normal" }, i = [...s];
  if (t !== "" && i.push({ content: t, type: "normal" }), i.push(l), e(i)) return ke(n, e, r, i);
...
m(et, "applyStyle");
async function Jt(n, e, r, s, t = false, l = Ot()) {
  let i = n.append("foreignObject");
  i.attr("width", `${10 * r}px`), i.attr("height", `${10 * r}px`);
  let o = i.append("xhtml:div"), a = nr(e.label) ? await qo(e.label.replace(hn.lineBreakRegex, `
`), l) : ot(e.label, l), c = e.isNode ? "nodeLabel" : "edgeLabel", h = o.append("span");
  ...
  return f.width === r && (o.style("display", "table"), o.style("white-space", "break-spaces"), o.style("width", r + "px"), f = o.node().getBoundingClientRect()), i.node();
}
m(Jt, "addHtmlSpan");
function xe(n, e, r) {
  return n.append("tspan").attr("class", "text-outer-tspan").attr("x", 0).attr("y", e * r - 0.1 + "em").attr("dy", r + "em");
}
m(xe, "createTspan");
function Yt2(n, e, r) {
  let s = n.append("text"), t = xe(s, 1, e);
  be(t, r);
  let l = t.node().getComputedTextLength();
  return s.remove(), l;
}
m(Yt2, "computeWidthOfText");
function $r(n, e, r) {
  let s = n.append("text"), t = xe(s, 1, e);
  be(t, [{ content: r, type: "normal" }]);
  let l = t.node()?.getBoundingClientRect();
  return l && s.remove(), l;
}
m($r, "computeDimensionOfText");
function en(n, e, r, s = false) {
  let l = e.append("g"), i = l.insert("rect").attr("class", "background").attr("style", "stroke: none"), o = l.append("text").attr("y", "-10.1"), a = 0;
  for (let c of r) {
    let h = m((u) => Yt2(l, 1.1, u) <= n, "checkWidth"), f = h(c) ? [c] : Ye(c, h);
    for (let u of f) {
      let m2 = xe(o, a, 1.1);
      be(m2, u), a++;
    }
...
function be(n, e) {
  n.text(""), e.forEach((r, s) => {
    let t = n.append("tspan").attr("font-style", r.type === "em" ? "italic" : "normal").attr("class", "text-inner-tspan").attr("font-weight", r.type === "strong" ? "bold" : "normal");
...
async function tn(n, e = {}) {
  let r = [];
  n.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (t, l, i) => (r.push((async () => {
    let o = `${l}:${i}`;
...
var Rr = m(async (n, e = "", { style: r = "", isTitle: s = false, classes: t = "", useHtmlLabels: l = true, isNode: i = true, width: o = 200, addSvgBackground: a = false } = {}, c) => {
  if (pt.debug("XYZ createText", e, r, s, t, l, i, "addSvgBackground: ", a), l) {
    let h = Xe(e, c), f = await tn(Yt(h), c), u = e.replace(/\\\\/g, "\\"), m2 = { isNode: i, label: nr(e) ? u : f, labelStyle: r.replace("fill:", "color:") };
    return await Jt(n, m2, o, t, a, c);
  } else {
    let h = e.replace(/<br\s*\/?>/g, "<br/>"), f = Ke(h.replace("<br>", "<br/>"), c), u = en(o, n, f, e ? a : false);
    if (i) {
      /stroke:/.exec(r) && (r = r.replace("stroke:", "lineColor:"));
      let m2 = r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
      ia(u).attr("style", m2);
    } else {
      let m2 = r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/background:/g, "fill:");
      ia(u).select("rect").attr("style", m2.replace(/background:/g, "fill:"));
      let k = r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
...
//# sourceMappingURL=chunk-W2EOFNDJ.js.map
