import {
  ...
  ny,
  za
} from "./chunk-G7VQXJND.js";
import {
  m
} from "./chunk-K5FX5IEL.js";

// node_modules/mermaid/dist/chunks/mermaid.esm.min/chunk-6XQQT3RD.mjs
...
var V = { parser: { TokenBuilder: F(() => new v(), "TokenBuilder"), ValueConverter: F(() => new h(), "ValueConverter") }, validation: { TreemapValidator: F(() => new C(), "TreemapValidator") } };
function M(r = Su) {
  let e = za($u(r), JN), t = za(ku({ shared: e }), iC, V);
...
//# sourceMappingURL=chunk-SM3KMJPL.js.map
