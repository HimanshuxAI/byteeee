...
var lt = function() {
  var t2 = m(function(x, o, a, l) {
  ...
  }, "anonymous"), table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, { 5: [1, 3] }, { 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: r, 20: i }, { 1: [2, 6], 7: 11, 10: [1, 12] }, t2(i, [2, 4], { 9: 13, 5: [1, 14] }), { 12: [1, 15] }, t2(u, [2, 8]), t2(u, [2, 9]), { 19: [1, 16] }, t2(u, [2, 11]), { 1: [2, 1] }, { 1: [2, 5] }, t2(i, [2, 2]), { 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: r, 20: i }, { 15: 18, 16: 7, 17: 8, 18: r, 20: i }, { 18: [1, 19] }, t2(i, [2, 3]), { 12: [1, 20] }, t2(u, [2, 10]), { 15: 21, 16: 7, 17: 8, 18: r, 20: i }, t2([1, 5, 10], [2, 7])], defaultActions: { 11: [2, 1], 12: [2, 5] }, parseError: m(function(o, a) {
    ...
    var a = this, l = [0], k = [], _ = [null], p = [], v = this.table, C = "", E = 0, M = 0, D = 0, z = 2, B = 1, R = p.slice.call(arguments, 1), w = Object.create(this.lexer), N = { yy: {} };
...
` + w.showPosition() + `
Expecting ` + I.join(", ") + ", got '" + (this.terminals_[A] || A) + "'" : j = "Parse error on line " + (E + 1) + ": Unexpected " + (A == B ? "end of input" : "'" + (this.terminals_[A] || A) + "'"), this.parseError(j, { text: w.match, token: this.terminals_[A] || A, line: w.yylineno, loc: O, expected: I });
      }
    ...
    var x = { EOF: 1, parseError: m(function(a, l) {
      if (this.yy.parser) this.yy.parser.parseError(a, l);
      else throw new Error(a);
    }, "parseError"), setInput: m(function(o, a) {
      return this.yy = a || this.yy || {}, this._input = o, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: l ? (l.length === k.length ? this.yylloc.first_column : 0) + k[k.length - l.length].length - l[0].length : this.yylloc.first_column - a }, this.options.ranges && (this.yylloc.range = [_[0], _[0] + this.yyleng - a]), this.yyleng = this.yytext.length, this;
...
` + a + "^";
      ...
      for (var _ = this._currentRules(), p = 0; p < _.length; p++) if (l = this._input.match(this.rules[_[p]]), l && (!a || l[0].length > a[0].length)) {
        if (a = l, k = p, this.options.backtrack_lexer) {
          if (o = this.test_match(l, _[p]), o !== false) return o;
          if (this._backtrack) {
            a = false;
            continue;
          } else return false;
      ...
      return a ? (o = this.test_match(a, _[k]), o !== false ? o : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: m(function() {
      var a = this.next();
      return a || this.lex();
    ...
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: m(function(a, l, k, _) {
      var p = _;
      switch (k) {
        case 0:
  ...
  return m(m2, "Parser"), m2.prototype = c, c.Parser = m2, new m2();
}();
lt.parser = lt;
var G = lt;
var tt = [];
...
var qt = m((t2) => {
  t2 = hn.sanitizeText(t2, mr());
  let r = Z.get(t2);
  return r === void 0 && (r = new ft(t2), Z.set(t2, r), et.push(r)), r;
}, "findOrCreateNode");
var Ut = m(() => et, "getNodes");
var Xt = m(() => tt, "getLinks");
var Gt = m(() => ({ nodes: et.map((t2) => ({ id: t2.ID })), links: tt.map((t2) => ({ source: t2.source.ID, target: t2.target.ID, value: t2.value })) }), "getGraph");
var Ot = { nodesMap: Z, getConfig: m(() => mr().sankey, "getConfig"), getNodes: Ut, getLinks: Xt, getGraph: Gt, addLink: Yt, findOrCreateNode: qt, getAccTitle: Uo, setAccTitle: Ho, getAccDescription: $o, setAccDescription: Go, getDiagramTitle: Vo, setDiagramTitle: jo, clear: Ht };
function J(t2, r) {
  let i;
  if (r === void 0) for (let u of t2) u != null && (i < u || i === void 0 && u >= u) && (i = u);
  else {
    let u = -1;
    for (let c of t2) (c = r(c, ++u, t2)) != null && (i < c || i === void 0 && c >= c) && (i = c);
  }
  return i;
}
m(J, "max");
...
function W(t2, r) {
  let i = 0;
  if (r === void 0) for (let u of t2) (u = +u) && (i += u);
  else {
    let u = -1;
    for (let c of t2) (c = +r(c, ++u, t2)) && (i += c);
  }
  return i;
}
m(W, "sum");
function Jt(t2) {
  return t2.target.depth;
}
m(Jt, "targetDepth");
function ct(t2) {
  return t2.depth;
...
m(ct, "left");
function ht(t2, r) {
  return r - 1 - t2.height;
}
m(ht, "right");
function Q(t2, r) {
  return t2.sourceLinks.length ? t2.depth : r - 1;
}
m(Q, "justify");
function dt(t2) {
  return t2.targetLinks.length ? t2.depth : t2.sourceLinks.length ? F(t2.sourceLinks, Jt) - 1 : 0;
}
m(dt, "center");
function H(t2) {
  return function() {
...
m(H, "constant");
function It(t2, r) {
  return nt(t2.source, r.source) || t2.index - r.index;
}
m(It, "ascendingSourceBreadth");
function Dt(t2, r) {
  return nt(t2.target, r.target) || t2.index - r.index;
}
...
function rt() {
  let t2 = 0, r = 0, i = 1, u = 1, c = 24, S = 8, m2, x = Qt, o = Q, a, l, k = Kt, _ = Zt, p = 6;
  function v() {
    let n = { nodes: k.apply(null, arguments), links: _.apply(null, arguments) };
  ...
  m(v, "sankey"), v.update = function(n) {
    ...
    return arguments.length ? (S = m2 = +n, v) : S;
  }, v.nodes = function(n) {
    ...
    return arguments.length ? (t2 = r = 0, i = +n[0], u = +n[1], v) : [i - t2, u - r];
  }, v.extent = function(n) {
    return arguments.length ? (t2 = +n[0][0], i = +n[1][0], r = +n[0][1], u = +n[1][1], v) : [[t2, r], [i, u]];
  ...
  function C({ nodes: n, links: f }) {
    ...
    let h = new Map(n.map((d, s) => [x(d, s, n), d]));
  ...
  function E({ nodes: n }) {
    for (let f of n) f.value = f.fixedValue === void 0 ? Math.max(W(f.sourceLinks, pt), W(f.targetLinks, pt)) : f.fixedValue;
  }
  ...
  function z({ nodes: n }) {
    let f = J(n, (s) => s.depth) + 1, h = (i - t2 - c) / (f - 1), d = new Array(f);
    for (let s of n) {
      let g = Math.max(0, Math.min(f - 1, Math.floor(o.call(null, s, f))));
      s.layer = g, s.x0 = t2 + g * h, s.x1 = s.x0 + c, d[g] ? d[g].push(s) : d[g] = [s];
    }
  ...
  function B(n) {
    let f = F(n, (h) => (u - r - (h.length - 1) * m2) / W(h, pt));
    for (let h of n) {
      let d = r;
      for (let s of h) {
        s.y0 = d, s.y1 = d + s.value * f, d = s.y1 + m2;
  ...
  function R(n) {
    let f = z(n);
    m2 = Math.min(S, (u - r) / (J(f, (h) => h.length) - 1)), B(f);
    for (let h = 0; h < p; ++h) {
      let d = Math.pow(0.99, h), s = Math.max(1 - d, (h + 1) / p);
      N(f, d, s), w(f, d, s);
    }
  }
  ...
  function P(n, f) {
    ...
    y(n, d.y0 - m2, h - 1, f), O(n, d.y1 + m2, h + 1, f), y(n, u, n.length - 1, f), O(n, r, 0, f);
  }
  m(P, "resolveCollisions");
  function O(n, f, h, d) {
    for (; h < n.length; ++h) {
      let s = n[h], g = (f - s.y0) * d;
      g > 1e-6 && (s.y0 += g, s.y1 += g), f = s.y1 + m2;
    }
  }
  ...
  function y(n, f, h, d) {
    for (; h >= 0; --h) {
      ...
      g > 1e-6 && (s.y0 -= g, s.y1 -= g), f = s.y0 - m2;
    }
  }
  ...
  m(st, "reorderLinks");
  function A(n, f) {
    let h = n.y0 - (n.sourceLinks.length - 1) * m2 / 2;
  ...
  m(A, "targetTop");
  function Y(n, f) {
    let h = f.y0 - (f.targetLinks.length - 1) * m2 / 2;
    for (let { source: d, width: s } of f.targetLinks) {
      if (d === n) break;
      h += s + m2;
    }
...
m(jt, "path");
gt.prototype = jt.prototype = { constructor: gt, moveTo: m(function(t2, r) {
  this._ += "M" + (this._x0 = this._x1 = +t2) + "," + (this._y0 = this._y1 = +r);
}, "moveTo"), closePath: m(function() {
  this._x1 !== null && (this._x1 = this._x0, this._y1 = this._y0, this._ += "Z");
}, "closePath"), lineTo: m(function(t2, r) {
  this._ += "L" + (this._x1 = +t2) + "," + (this._y1 = +r);
}, "lineTo"), quadraticCurveTo: m(function(t2, r, i, u) {
  this._ += "Q" + +t2 + "," + +r + "," + (this._x1 = +i) + "," + (this._y1 = +u);
}, "quadraticCurveTo"), bezierCurveTo: m(function(t2, r, i, u, c, S) {
  this._ += "C" + +t2 + "," + +r + "," + +i + "," + +u + "," + (this._x1 = +c) + "," + (this._y1 = +S);
}, "bezierCurveTo"), arcTo: m(function(t2, r, i, u, c) {
  t2 = +t2, r = +r, i = +i, u = +u, c = +c;
  var S = this._x1, m2 = this._y1, x = i - t2, o = u - r, a = S - t2, l = m2 - r, k = a * a + l * l;
  if (c < 0) throw new Error("negative radius: " + c);
  if (this._x1 === null) this._ += "M" + (this._x1 = t2) + "," + (this._y1 = r);
  else if (k > V) if (!(Math.abs(l * x - o * a) > V) || !c) this._ += "L" + (this._x1 = t2) + "," + (this._y1 = r);
  else {
    var _ = i - S, p = u - m2, v = x * x + o * o, C = _ * _ + p * p, E = Math.sqrt(v), M = Math.sqrt(k), D = c * Math.tan((yt - Math.acos((v + k - C) / (2 * E * M))) / 2), z = D / M, B = D / E;
    Math.abs(z - 1) > V && (this._ += "L" + (t2 + z * a) + "," + (r + z * l)), this._ += "A" + c + "," + c + ",0,0," + +(l * _ > a * p) + "," + (this._x1 = t2 + B * x) + "," + (this._y1 = r + B * o);
  }
}, "arcTo"), arc: m(function(t2, r, i, u, c, S) {
  t2 = +t2, r = +r, i = +i, S = !!S;
  var m2 = i * Math.cos(u), x = i * Math.sin(u), o = t2 + m2, a = r + x, l = 1 ^ S, k = S ? u - c : c - u;
  if (i < 0) throw new Error("negative radius: " + i);
  this._x1 === null ? this._ += "M" + o + "," + a : (Math.abs(this._x1 - o) > V || Math.abs(this._y1 - a) > V) && (this._ += "L" + o + "," + a), i && (k < 0 && (k = k % mt + mt), k > te ? this._ += "A" + i + "," + i + ",0,1," + l + "," + (t2 - m2) + "," + (r - x) + "A" + i + "," + i + ",0,1," + l + "," + (this._x1 = o) + "," + (this._y1 = a) : k > V && (this._ += "A" + i + "," + i + ",0," + +(k >= yt) + "," + l + "," + (this._x1 = t2 + i * Math.cos(c)) + "," + (this._y1 = r + i * Math.sin(c))));
}, "arc"), rect: m(function(t2, r, i, u) {
  this._ += "M" + (this._x0 = this._x1 = +t2) + "," + (this._y0 = this._y1 = +r) + "h" + +i + "v" + +u + "h" + -i + "Z";
}, "rect"), toString: m(function() {
  return this._;
}, "toString") };
var xt = jt;
function ot(t2) {
...
function re(t2) {
  ...
  function m2() {
    ...
    if (S || (S = x = xt()), t2(S, +u.apply(this, (o[0] = a, o)), +c.apply(this, o), +u.apply(this, (o[0] = l, o)), +c.apply(this, o)), x) return S = null, x + "" || null;
  }
  return m(m2, "link"), m2.source = function(x) {
    return arguments.length ? (r = x, m2) : r;
  }, m2.target = function(x) {
    return arguments.length ? (i = x, m2) : i;
  }, m2.x = function(x) {
    return arguments.length ? (u = typeof x == "function" ? x : ot(+x), m2) : u;
  }, m2.y = function(x) {
    return arguments.length ? (c = typeof x == "function" ? x : ot(+x), m2) : c;
  }, m2.context = function(x) {
    return arguments.length ? (S = x ?? null, m2) : S;
  }, m2;
}
m(re, "link");
function oe(t2, r, i, u, c) {
  t2.moveTo(r, i), t2.bezierCurveTo(r = (r + u) / 2, i, r, c, u, c);
}
...
m(kt, "linkHorizontal");
function ie(t2) {
  return [t2.source.x1, t2.y0];
}
m(ie, "horizontalSource");
function se(t2) {
  return [t2.target.x0, t2.y1];
}
...
var ae = { left: ct, right: ht, center: dt, justify: Q };
var le = m(function(t2, r, i, u) {
  let { securityLevel: c, sankey: S } = mr(), m2 = An.sankey, x;
  c === "sandbox" && (x = ia("#i" + r));
  let o = c === "sandbox" ? ia(x.nodes()[0].contentDocument.body) : ia("body"), a = c === "sandbox" ? o.select(`[id="${r}"]`) : ia(`[id="${r}"]`), l = S?.width ?? m2.width, k = S?.height ?? m2.width, _ = S?.useMaxWidth ?? m2.useMaxWidth, p = S?.nodeAlignment ?? m2.nodeAlignment, v = S?.prefix ?? m2.prefix, C = S?.suffix ?? m2.suffix, E = S?.showValues ?? m2.showValues, M = u.db.getGraph(), D = ae[p];
...
${v}${Math.round(T * 100) / 100}${C}` : y, "getText");
  ...
  let N = a.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(M.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), P = S?.linkColor ?? "gradient";
  if (P === "gradient") {
  ...
  switch (P) {
    case "gradient":
      O = m((y) => y.uid, "coloring");
      break;
    case "source":
      O = m((y) => R(y.source.id), "coloring");
      break;
    case "target":
      O = m((y) => R(y.target.id), "coloring");
      break;
    default:
      O = P;
  }
  N.append("path").attr("d", it()).attr("stroke", O).attr("stroke-width", (y) => Math.max(1, y.width)), dr(void 0, a, 0, _);
}, "draw");
var Vt = { draw: le };
var Ft = m((t2) => t2.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), "prepareTextForParsing");
var ue = m((t2) => `.label {
      font-family: ${t2.fontFamily};
    }`, "getStyles");
var Wt = ue;
var fe = G.parse.bind(G);
G.parse = (t2) => fe(Ft(t2));
var Cn = { styles: Wt, parser: G, db: Ot, renderer: Vt };
export {
  Cn as diagram
};
//# sourceMappingURL=sankeyDiagram-XSL23WO4-AKCEJUS7.js.map
