...
var ComputerUseScreenshotActionSchema = external_exports.object({ type: external_exports.literal("screenshot") });
var ComputerUseClickActionSchema = external_exports.object({
  type: external_exports.literal("click"),
  x: external_exports.number(),
  y: external_exports.number(),
  button: external_exports.enum([
    "left",
    "right",
    "wheel",
    "back",
...
var ComputerUseDoubleClickActionSchema = external_exports.object({
...
var ComputerUseDragActionSchema = external_exports.object({
...
var ComputerUseKeypressActionSchema = external_exports.object({
  type: external_exports.literal("keypress"),
  keys: external_exports.array(external_exports.string())
});
var ComputerUseMoveActionSchema = external_exports.object({
  type: external_exports.literal("move"),
  x: external_exports.number(),
  y: external_exports.number()
});
var ComputerUseScrollActionSchema = external_exports.object({
...
var ComputerUseTypeActionSchema = external_exports.object({
  type: external_exports.literal("type"),
  text: external_exports.string()
});
var ComputerUseWaitActionSchema = external_exports.object({
  type: external_exports.literal("wait"),
  duration: external_exports.number().optional()
});
var ComputerUseActionUnionSchema = external_exports.discriminatedUnion("type", [
...
var ComputerUseActionSchema = external_exports.object({ action: ComputerUseActionUnionSchema });
...
var LocalShellExecActionSchema = external_exports.object({
...
var LocalShellActionSchema = external_exports.discriminatedUnion("type", [LocalShellExecActionSchema]);
...
var ShellActionSchema = external_exports.object({
  commands: external_exports.array(external_exports.string()).describe("Array of shell commands to execute"),
  timeout_ms: external_exports.number().optional().describe("Optional timeout in milliseconds for the commands"),
  max_output_length: external_exports.number().optional().describe("Optional maximum number of characters to return from each command")
});
...
var ApplyPatchCreateFileOperationSchema = external_exports.object({
  type: external_exports.literal("create_file"),
  path: external_exports.string(),
  diff: external_exports.string()
});
var ApplyPatchUpdateFileOperationSchema = external_exports.object({
  type: external_exports.literal("update_file"),
  path: external_exports.string(),
  diff: external_exports.string()
});
var ApplyPatchDeleteFileOperationSchema = external_exports.object({
  type: external_exports.literal("delete_file"),
  path: external_exports.string()
});
var ApplyPatchOperationSchema = external_exports.discriminatedUnion("type", [
