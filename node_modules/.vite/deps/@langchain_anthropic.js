...
} from "./chunk-T2PV7Z25.js";
import {
  isLangChainTool,
  isOpenAITool
} from "./chunk-OEMM7VDW.js";
import "./chunk-YN7YRZI4.js";
import "./chunk-2MZWBT4H.js";
import {
  AIMessage,
  AIMessageChunk,
  ChatGenerationChunk,
  ...
  parseBase64DataUrl,
  toJsonSchema
} from "./chunk-KCSK77CP.js";
import "./chunk-LNZMOREG.js";
...
var AnthropicToolsOutputParser = class extends BaseLLMOutputParser {
  ...
  async parseResult(generations) {
    const tools2 = generations.flatMap((generation) => {
      const { message } = generation;
      if (!Array.isArray(message.content)) return [];
      const tool$1 = extractToolCalls(message.content)[0];
      return tool$1;
    });
    if (tools2[0] === void 0) throw new Error("No parseable tool calls provided to AnthropicToolsOutputParser.");
    const [tool2] = tools2;
...
var AnthropicToolExtrasSchema = object({
  cache_control: custom().optional().nullable(),
  defer_loading: boolean().optional(),
  input_examples: array(unknown()).optional(),
  allowed_callers: array(unknown()).optional()
});
var ANTHROPIC_TOOL_BETAS = {
...
// node_modules/@langchain/anthropic/dist/utils/index.js
var iife = (fn) => fn();
...
// node_modules/@langchain/anthropic/dist/profiles.js
var PROFILES = {
  "claude-opus-4-0": {
    maxInputTokens: 2e5,
    imageInputs: true,
...
var MODEL_DEFAULT_MAX_OUTPUT_TOKENS = {
...
var FALLBACK_MAX_OUTPUT_TOKENS = 2048;
...
function isBuiltinTool(tool2) {
  ...
  return typeof tool2 === "object" && tool2 !== null && "type" in tool2 && ("name" in tool2 || "mcp_server_name" in tool2) && typeof tool2.type === "string" && builtInToolPrefixes.some((prefix) => typeof tool2.type === "string" && tool2.type.startsWith(prefix));
}
function _combineBetas(a, b, ...rest) {
  return Array.from(/* @__PURE__ */ new Set([
    ...a ?? [],
    ...b ?? [],
    ...rest.flatMap((x) => Array.from(x))
  ]));
}
...
var ChatAnthropicMessages = class extends BaseChatModel {
  ...
  */
  formatStructuredToolToAnthropic(tools2) {
    if (!tools2) return void 0;
    return tools2.map((tool2) => {
      if (isLangChainTool(tool2) && tool2.extras?.providerToolDefinition) return tool2.extras.providerToolDefinition;
      if (isBuiltinTool(tool2)) return tool2;
      if (isAnthropicTool(tool2)) return tool2;
      if (isOpenAITool(tool2)) return {
        name: tool2.function.name,
        description: tool2.function.description,
        input_schema: tool2.function.parameters
      };
      if (isLangChainTool(tool2)) return {
        name: tool2.name,
        description: tool2.description,
        input_schema: isInteropZodSchema(tool2.schema) ? toJsonSchema(tool2.schema) : tool2.schema,
        ...tool2.extras ? AnthropicToolExtrasSchema.parse(tool2.extras) : {}
      };
  ...
  bindTools(tools2, kwargs) {
    return this.withConfig({
      tools: this.formatStructuredToolToAnthropic(tools2),
      ...kwargs
    });
  }
  /**
  ...
  */
  invocationParams(options) {
    ...
    const toolBetas = options?.tools?.reduce((acc, tool2) => {
      if (typeof tool2 === "object" && "type" in tool2 && tool2.type in ANTHROPIC_TOOL_BETAS) {
        const beta = ANTHROPIC_TOOL_BETAS[tool2.type];
        if (!acc.includes(beta)) return [...acc, beta];
      }
      return acc;
    }, []);
    const output = {
...
// node_modules/@langchain/anthropic/dist/tools/types.js
var Memory20250818ViewCommandSchema = external_exports.object({
  command: external_exports.literal("view"),
  path: external_exports.string()
});
var Memory20250818CreateCommandSchema = external_exports.object({
  command: external_exports.literal("create"),
  path: external_exports.string(),
  file_text: external_exports.string()
});
var Memory20250818StrReplaceCommandSchema = external_exports.object({
  command: external_exports.literal("str_replace"),
  path: external_exports.string(),
  old_str: external_exports.string(),
  new_str: external_exports.string()
});
var Memory20250818InsertCommandSchema = external_exports.object({
  command: external_exports.literal("insert"),
  path: external_exports.string(),
  insert_line: external_exports.number(),
  insert_text: external_exports.string()
});
var Memory20250818DeleteCommandSchema = external_exports.object({
  command: external_exports.literal("delete"),
  path: external_exports.string()
});
var Memory20250818RenameCommandSchema = external_exports.object({
  command: external_exports.literal("rename"),
  old_path: external_exports.string(),
  new_path: external_exports.string()
});
var Memory20250818CommandSchema = external_exports.discriminatedUnion("command", [
...
var TextEditor20250728ViewCommandSchema = external_exports.object({
  command: external_exports.literal("view"),
  path: external_exports.string(),
  view_range: external_exports.tuple([external_exports.number(), external_exports.number()]).optional()
});
var TextEditor20250728StrReplaceCommandSchema = external_exports.object({
  command: external_exports.literal("str_replace"),
  path: external_exports.string(),
  old_str: external_exports.string(),
  new_str: external_exports.string()
});
var TextEditor20250728CreateCommandSchema = external_exports.object({
  command: external_exports.literal("create"),
  path: external_exports.string(),
  file_text: external_exports.string()
});
var TextEditor20250728InsertCommandSchema = external_exports.object({
  command: external_exports.literal("insert"),
  path: external_exports.string(),
  insert_line: external_exports.number(),
  new_str: external_exports.string()
});
var TextEditor20250728CommandSchema = external_exports.discriminatedUnion("command", [
...
var coordinateSchema = external_exports.tuple([external_exports.number(), external_exports.number()]);
var ComputerScreenshotActionSchema = external_exports.object({ action: external_exports.literal("screenshot") });
var ComputerLeftClickActionSchema = external_exports.object({
  action: external_exports.literal("left_click"),
  coordinate: coordinateSchema
});
var ComputerRightClickActionSchema = external_exports.object({
  action: external_exports.literal("right_click"),
  coordinate: coordinateSchema
});
var ComputerMiddleClickActionSchema = external_exports.object({
  action: external_exports.literal("middle_click"),
  coordinate: coordinateSchema
});
var ComputerDoubleClickActionSchema = external_exports.object({
  action: external_exports.literal("double_click"),
  coordinate: coordinateSchema
});
var ComputerTripleClickActionSchema = external_exports.object({
  action: external_exports.literal("triple_click"),
  coordinate: coordinateSchema
});
var ComputerLeftClickDragActionSchema = external_exports.object({
  action: external_exports.literal("left_click_drag"),
  start_coordinate: coordinateSchema,
  end_coordinate: coordinateSchema
});
var ComputerLeftMouseDownActionSchema = external_exports.object({
  action: external_exports.literal("left_mouse_down"),
  coordinate: coordinateSchema
});
var ComputerLeftMouseUpActionSchema = external_exports.object({
  action: external_exports.literal("left_mouse_up"),
  coordinate: coordinateSchema
});
var ComputerScrollActionSchema = external_exports.object({
  ...
  scroll_amount: external_exports.number()
});
var ComputerTypeActionSchema = external_exports.object({
  action: external_exports.literal("type"),
  text: external_exports.string()
});
var ComputerKeyActionSchema = external_exports.object({
  action: external_exports.literal("key"),
  key: external_exports.string()
});
var ComputerMouseMoveActionSchema = external_exports.object({
  action: external_exports.literal("mouse_move"),
  coordinate: coordinateSchema
});
var ComputerHoldKeyActionSchema = external_exports.object({
  action: external_exports.literal("hold_key"),
  key: external_exports.string()
});
var ComputerWaitActionSchema = external_exports.object({
  action: external_exports.literal("wait"),
  duration: external_exports.number().optional()
});
var ComputerZoomActionSchema = external_exports.object({
  action: external_exports.literal("zoom"),
...
var Computer20250124ActionSchema = external_exports.discriminatedUnion("action", [
...
var Computer20251124ActionSchema = external_exports.discriminatedUnion("action", [
  ComputerScreenshotActionSchema,
  ComputerLeftClickActionSchema,
  ComputerRightClickActionSchema,
  ComputerMiddleClickActionSchema,
...
var Bash20250124ExecuteCommandSchema = external_exports.object({ command: external_exports.string().describe("The bash command to run") });
var Bash20250124RestartCommandSchema = external_exports.object({ restart: external_exports.literal(true).describe("Set to true to restart the bash session") });
var Bash20250124CommandSchema = external_exports.union([Bash20250124ExecuteCommandSchema, Bash20250124RestartCommandSchema]);

// node_modules/@langchain/anthropic/dist/tools/memory.js
...
// node_modules/@langchain/anthropic/dist/tools/webSearch.js
...
// node_modules/@langchain/anthropic/dist/tools/webFetch.js
...
// node_modules/@langchain/anthropic/dist/tools/toolSearch.js
...
// node_modules/@langchain/anthropic/dist/tools/textEditor.js
...
// node_modules/@langchain/anthropic/dist/tools/computer.js
var TOOL_NAME = "computer";
...
// node_modules/@langchain/anthropic/dist/tools/codeExecution.js
...
// node_modules/@langchain/anthropic/dist/tools/bash.js
...
// node_modules/@langchain/anthropic/dist/tools/mcpToolset.js
...
// node_modules/@langchain/anthropic/dist/tools/index.js
var tools = {
  memory_20250818,
  webSearch_20250305,
  webFetch_20250910,
...
//# sourceMappingURL=@langchain_anthropic.js.map
