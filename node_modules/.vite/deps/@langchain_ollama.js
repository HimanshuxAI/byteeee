...
// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/regex.js
var regex_default = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i;

// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/validate.js
function validate(uuid) {
  return typeof uuid === "string" && regex_default.test(uuid);
}
var validate_default = validate;

// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/parse.js
function parse(uuid) {
...
// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/v35.js
...
// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/md5.js
function md5(bytes) {
...
// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/v3.js
...
// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/sha1.js
function f(s, x, y, z) {
  switch (s) {
    case 0:
      return x & y ^ ~x & z;
...
// node_modules/@langchain/ollama/node_modules/uuid/dist/esm-browser/v5.js
...
var Ollama$12 = class extends LLM {
  static lc_name() {
    return "Ollama";
  }
  ...
  constructor(fields) {
    super(fields ?? {});
    this.model = fields?.model ?? this.model;
    this.baseUrl = fields?.baseUrl ? fields?.baseUrl.endsWith("/") ? fields?.baseUrl.slice(0, -1) : fields?.baseUrl : getEnvironmentVariable("OLLAMA_BASE_URL") ?? this.baseUrl;
    this.client = new Ollama$1({
      fetch: fields?.fetch,
      host: this.baseUrl,
      headers: fields?.headers
  ...
  async *_streamResponseChunks(prompt, options, runManager) {
    ...
    for await (const chunk of stream) {
      ...
      if (!chunk.done) {
        const token = this.think || this.think === void 0 ? chunk.thinking ?? chunk.response ?? "" : chunk.response ?? "";
        ...
        await runManager?.handleLLMNewToken(token);
      } else yield new GenerationChunk({
        text: "",
        generationInfo: {
          model: chunk.model,
...
//# sourceMappingURL=@langchain_ollama.js.map
