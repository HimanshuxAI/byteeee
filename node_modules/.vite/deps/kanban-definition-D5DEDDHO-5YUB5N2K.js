...
var ie = function() {
  var e = m(function(v, i, n, s) {
  ...
  }, "anonymous"), table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: g2 }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: g2 }, { 6: p, 7: [1, 10], 9: 9, 12: 11, 13: r, 14: 14, 16: d2, 17: _, 18: 17, 19: 18, 20: b, 23: l }, e(L, [2, 3]), { 1: [2, 2] }, e(L, [2, 4]), e(L, [2, 5]), { 1: [2, 6], 6: p, 12: 21, 13: r, 14: 14, 16: d2, 17: _, 18: 17, 19: 18, 20: b, 23: l }, { 6: p, 9: 22, 12: 11, 13: r, 14: 14, 16: d2, 17: _, 18: 17, 19: 18, 20: b, 23: l }, { 6: C, 7: u, 10: 23, 11: w }, e(k, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: b, 23: l }), e(k, [2, 19]), e(k, [2, 21], { 15: 30, 24: K }), e(k, [2, 22]), e(k, [2, 23]), e(N, [2, 25]), e(N, [2, 26]), e(N, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: C, 7: u, 10: 34, 11: w }, { 1: [2, 7], 6: p, 12: 21, 13: r, 14: 14, 16: d2, 17: _, 18: 17, 19: 18, 20: b, 23: l }, e(M, [2, 14], { 7: y, 11: A }), e(O, [2, 8]), e(O, [2, 9]), e(O, [2, 10]), e(k, [2, 16], { 15: 37, 24: K }), e(k, [2, 17]), e(k, [2, 18]), e(k, [2, 20], { 24: U2 }), e(N, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, e(M, [2, 13], { 7: y, 11: A }), e(O, [2, 11]), e(O, [2, 12]), e(k, [2, 15], { 24: U2 }), e(N, [2, 30]), { 22: [1, 41] }, e(N, [2, 27]), e(N, [2, 29])], defaultActions: { 2: [2, 1], 6: [2, 2] }, parseError: m(function(i, n) {
    ...
    var n = this, s = [0], a = [], h = [null], t = [], R = this.table, c2 = "", z = 0, ae = 0, ce = 0, xe = 2, le = 1, Le = t.slice.call(arguments, 1), m2 = Object.create(this.lexer), P = { yy: {} };
    for (var q in this.yy) Object.prototype.hasOwnProperty.call(this.yy, q) && (P.yy[q] = this.yy[q]);
    m2.setInput(i, P.yy), P.yy.lexer = m2, P.yy.parser = this, typeof m2.yylloc > "u" && (m2.yylloc = {});
    var Q = m2.yylloc;
    t.push(Q);
    var Oe = m2.options && m2.options.ranges;
    ...
    function ve() {
      var S;
      return S = a.pop() || m2.lex() || le, typeof S != "number" && (S instanceof Array && (a = S, S = a.pop()), S = n.symbols_[S] || S), S;
    }
    m(ve, "lex");
    for (var E, Z, j, D, He, $, G = {}, X, I, he, Y; ; ) {
      if (j = s[s.length - 1], this.defaultActions[j] ? D = this.defaultActions[j] : ((E === null || typeof E > "u") && (E = ve()), D = R[j] && R[j][E]), typeof D > "u" || !D.length || !D[0]) {
        var ee = "";
        Y = [];
        for (X in R[j]) this.terminals_[X] && X > xe && Y.push("'" + this.terminals_[X] + "'");
        m2.showPosition ? ee = "Parse error on line " + (z + 1) + `:
` + m2.showPosition() + `
Expecting ` + Y.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : ee = "Parse error on line " + (z + 1) + ": Unexpected " + (E == le ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(ee, { text: m2.match, token: this.terminals_[E] || E, line: m2.yylineno, loc: Q, expected: Y });
      }
      if (D[0] instanceof Array && D.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + j + ", token: " + E);
      switch (D[0]) {
        case 1:
          s.push(E), h.push(m2.yytext), t.push(m2.yylloc), s.push(D[1]), E = null, Z ? (E = Z, Z = null) : (ae = m2.yyleng, c2 = m2.yytext, z = m2.yylineno, Q = m2.yylloc, ce > 0 && ce--);
          break;
        case 2:
    ...
    var v = { EOF: 1, parseError: m(function(n, s) {
      if (this.yy.parser) this.yy.parser.parseError(n, s);
      else throw new Error(n);
    }, "parseError"), setInput: m(function(i, n) {
      return this.yy = n || this.yy || {}, this._input = i, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
...
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    ...
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: m(function(n, s, a, h) {
      var t = h;
      switch (a) {
        case 0:
...
var Ie = m((e) => {
  ...
  let g2 = x[0].level, p = null;
  for (let r = x.length - 1; r >= 0; r--) if (x[r].level === g2 && !p && (p = x[r]), x[r].level < g2) throw new Error('Items without section detected, found section ("' + x[r].label + '")');
...
var we = m(function() {
  let e = [], g2 = [], p = _e(), r = mr();
  for (let d2 of p) {
    let _ = { id: d2.id, label: ot(d2.label ?? "", r), isGroup: true, ticket: d2.ticket, shape: "kanbanSection", level: d2.level, look: r.look };
    g2.push(_);
    let b = x.filter((l) => l.parentId === d2.id);
    for (let l of b) {
      let L = { id: l.id, parentId: d2.id, label: ot(l.label ?? "", r), isGroup: false, ticket: l?.ticket, priority: l?.priority, assigned: l?.assigned, icon: l?.icon, shape: "kanbanItem", level: l.level, rx: 5, ry: 5, cssStyles: ["text-align: left"] };
      g2.push(L);
    }
  }
  return { nodes: g2, edges: e, other: {}, config: mr() };
}, "getData");
var Ae = m((e, g2, p, r, d2) => {
  let _ = mr(), b = _.mindmap?.padding ?? Ni.mindmap.padding;
  switch (r) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
  ...
  let l = { id: ot(g2, _) || "kbn" + re++, level: e, label: ot(p, _), width: _.mindmap?.maxNodeWidth ?? Ni.mindmap.maxNodeWidth, padding: b, isGroup: false };
  if (d2 !== void 0) {
    let C;
    d2.includes(`
`) ? C = d2 + `
...
var Te = m((e, g2) => {
  switch (pt.debug("In get type", e, g2), e) {
    case "[":
      return f.RECT;
    case "(":
      return g2 === ")" ? f.ROUNDED_RECT : f.CLOUD;
    case "((":
      return f.CIRCLE;
    case ")":
      return f.CLOUD;
...
var Pe = m((e) => {
  if (!e) return;
  let g2 = mr(), p = x[x.length - 1];
  e.icon && (p.icon = ot(e.icon, g2)), e.class && (p.cssClasses = ot(e.class, g2));
}, "decorateNode");
var je = m((e) => {
  switch (e) {
    case f.DEFAULT:
...
var Me = { clear: Ce, addNode: Ae, getSections: _e, getData: we, nodeType: f, getType: Te, setElementForId: Re, decorateNode: Pe, type2Str: je, getLogger: Be, getElementById: Ve };
var Se = Me;
var Ge = m(async (e, g2, p, r) => {
  pt.debug(`Rendering kanban diagram
` + e);
  let _ = r.db.getData(), b = mr();
  b.htmlLabels = false;
  let l = d(g2), L = l.append("g");
  L.attr("class", "sections");
  let C = l.append("g");
  C.attr("class", "items");
  let u = _.nodes.filter((y) => y.isGroup), w = 0, k = 10, K = [], N = 25;
  for (let y of u) {
  ...
  for (let y of u) {
    let A = K[M];
    M = M + 1;
    let O = b?.kanban?.sectionWidth || 200, U2 = -O * 3 / 2 + N, T = U2, J = _.nodes.filter((i) => i.parentId === y.id);
    for (let i of J) {
      if (i.isGroup) throw new Error("Groups within groups are not allowed in Kanban diagrams");
      i.x = y.x, i.width = O - 1.5 * k;
      let s = (await Td(C, i, { config: b })).node().getBBox();
      i.y = T + s.height / 2, await Ed(i), T = i.y + s.height / 2 + k / 2;
    }
    let H = A.cluster.select("rect"), v = Math.max(T - U2 + 3 * k, 50) + (N - 25);
    H.attr("height", v);
  }
  dr(void 0, l, b.mindmap?.padding ?? Ni.kanban.padding, b.mindmap?.useMaxWidth ?? Ni.kanban.useMaxWidth);
}, "draw");
var Ne = { draw: Ge };
var Fe = m((e) => {
  let g2 = "";
  for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) e["lineColor" + r] = e["lineColor" + r] || e["cScaleInv" + r], U(e["lineColor" + r]) ? e["lineColor" + r] = c(e["lineColor" + r], 20) : e["lineColor" + r] = g(e["lineColor" + r], 20);
  let p = m((r, d2) => e.darkMode ? g(r, d2) : c(r, d2), "adjuster");
...
//# sourceMappingURL=kanban-definition-D5DEDDHO-5YUB5N2K.js.map
